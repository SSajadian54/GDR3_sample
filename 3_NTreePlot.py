...
plt.plot(fore[:,0], fore[:,1], 'b--',lw=2.5, label=r"$\sigma_{\rm{R}}$")
plt.plot(fore[:,0], fore[:,2], 'm--',lw=2.5, label=r"$\sigma_{\rm{T}}$")
plt.plot(fore[:,0], fore[:,3], 'g--',lw=2.5, label=r"$\sigma_{\rm{Z}}$")
plt.plot(fore[:,0], fore[:,4],'r--',lw=2.5, label=r"$\sigma_{\rm{tot}}$")
